                ...
                <form  className='form-order' >
                    ...
                    <div className='form-line'>
                        ...
                        <div className='input-row2 col-12 col-sm-3'>
                            <label htmlFor="code-employee"><span>Code Employee:</span></label>
                            <input type="text" name='code-employee' className='input-order' />
                        </div>
                    </div>
                    ...
                    <div className='form-line'>
                        <div className='input-row2 col-12 '>
                            ...
                            <textarea type="text" name='spareParts' className='area-description'  rows={4} />
                        </div>
                    </div>
                    ...
                    <div className='form-line'>
                        <div className='input-row2 col-12'>
                            ...
                            <textarea type="text" name='comments-maintenance' className='area-description' rows={4} />
                        </div>
                    </div>
