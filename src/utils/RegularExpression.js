...
export const er = {
    ...
    text: /^[ a-zA-ZñÑáéíóúÁÉÍÓÚ]+$/,    // validates a string of only lowercase letters, uppercase letters, numbers, includes accents but includes spaces.
    user: /^[a-z0-9_-]{3,24}$/,   // lowercase letters, numbers, underscore, and hyphen. Usernames must be between 3 and 24 characters.
    code: /^[a-zA-Z0-9_-]{2,16}$/,   // lowercase letters, uppercase letters, numbers, underscore, and hyphen. code must be between 2 and 16 characters.
}
